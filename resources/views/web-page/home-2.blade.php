...
<div class="no-bottom no-top" id="content">
    <div id="top"></div>
    <section id="section-hero" class="no-top no-bottom full-height text-light jarallax" aria-label="section" data-video-src="mp4:assets/video/local-video.mp4,webm:assets/video/local-video.webm,ogv:assets/video/local-video.ogv">
        <div class="container position-relative z1000">
            <div class="row align-items-center">
                <div class="col-lg-6 offset-lg-1 mb-sm-30">
                    <div class="de-title-2">
                        <h3 class="id-color wow fadeInUp " data-wow-delay=".3s">Specials</h3>
        ...
        <a href="#section-gallery" class="mouse-s1 mouse-icon-click scroll-to wow fadeInUp" data-wow-delay="2s">
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-4 wow fadeInRight">
                    <img src="assets/img/misc/icon-1.png" alt="">
                ...
                <div class="col-md-4 wow fadeInRight" data-wow-delay=".1s">
                    <img src="assets/img/misc/icon-2.png" alt="">
                    <div class="spacer-single"></div>
                ...
                <div class="col-md-4 wow fadeInRight" data-wow-delay=".2s">
                    <img src="assets/img/misc/icon-3.png" alt="">
                    <div class="spacer-single"></div>
    ...
    <section id="section-quote" aria-label="section" class="jarallax">
        <img class="jarallax-img" src="assets/img/background/9.jpg" alt="" />
        <div class="container">
            <div class="row align-items-center">
